...
const PrecipitationGraphe=(props) =>{
  ...
  const data3 = [ 
    { quarter:newDate1, earnings:float2int(stationn.pre['j-5'].Pr),label:stationn.pre['j-5'].Pr},
    { quarter:newDate2, earnings:float2int(stationn.pre['j-4'].Pr),label:stationn.pre['j-4'].Pr},
    { quarter:newDate3, earnings:float2int(stationn.pre['j-3'].Pr),label:stationn.pre['j-3'].Pr},
    { quarter:newDate4, earnings:float2int(stationn.pre['j-2'].Pr),label:stationn.pre['j-2'].Pr},
    { quarter:newDate5, earnings:float2int(stationn.pre['j-1'].Pr),label:stationn.pre['j-1'].Pr},
    { quarter:newDate6, earnings:float2int(stationn.pre['j'].Pr),label:stationn.pre['j'].Pr},
    { quarter:newDate7, earnings:float2int(stationn.pre['j+1'].Pr),label:stationn.pre['j+1'].Pr},
    { quarter:newDate8, earnings:float2int(stationn.pre['j+2'].Pr),label:stationn.pre['j+2'].Pr},
  ];
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          <Image  source={require('../images/ArrierePr.png')} style={styles.headerImage}/>
          <Header onPress={checking} deconnecter={Deconnecter}/>
        </View>
        <ScrollView  style={styles.container}>
        <Image  source={require('../images/ArrierePr.png')} style={styles.imageBackground}/>
          ...
          <View style={styles.dateEtPrecipitation}>
            <Text style={styles.date}>{state.reponse['data infomation']['j'].Date}</Text> 
            <Image source={require('../images/petit-nuage.png')} style={styles.precipitationImage} />
            <View>
              <Text style={styles.precipitationText}>Précipitation</Text> 
...
export default PrecipitationGraphe;
