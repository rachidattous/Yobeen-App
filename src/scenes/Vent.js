...
const Vent=(props)=> {
  ...
  const alldevice = (a) => {
    if (a != 1000) {
      ...
      setData({
        ...
        Vvent: state.reponse['devices'][a]['data'][0]['j'].Vvent,
      })
    }
  };
  ...
  const checking2 = async () => {
    try{    
      ...
      props.navigation.navigate('VentGraph',{index})
    } } catch (e) {
      }
  };
      ...
      const synchron = await  axios.get(url2,
        ...
        if (!state.reponse['isActive'] || test.isActive== false) {
          ...
          if(props.navigation.state.params.indexx!=1000){
            setData({
              dateJ:state.reponse['data infomation']['j'].Date,
              Vvent: state.reponse['devices'][props.navigation.state.params.indexx]['data'][0]['j'].Vvent,
            });
          } else {
            setData({
              dateJ:state.reponse['data infomation']['j'].Date,
        ...
        if (!state.reponse['isActive'] || test.isActive== false) {
          ...
          if(props.navigation.state.params.indexx!=1000){
            setData({
              ...
              Vvent: state.reponse['devices'][props.navigation.state.params.indexx]['data'][0]['j-1'].Vvent,
            });
          } else {
            setData({
              dateJ:state.reponse['data infomation']['j-1'].Date,
              Vvent: state.reponse['data infomation']['j-1'].Vvent,
            });
          }
            setDate({
        ...
        if (!state.reponse['isActive'] || test.isActive== false) {
          ...
          if(props.navigation.state.params.indexx!=1000){
            setData({
              ...
              Vvent: state.reponse['devices'][props.navigation.state.params.indexx]['data'][0]['j+2'].Vvent,
            });
          } else {
            setData({
              dateJ:state.reponse['data infomation']['j+2'].Date,
              Vvent: state.reponse['data infomation']['j+2'].Vvent,
            });
          }
            setDate({
